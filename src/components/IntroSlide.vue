<template>
  <div class="container">
    <swiper-container
      class="w-4/5 xl:w-5/6 min-[1920px]:w-full"
      ref="swiperEl"
      :autoplay="{ delay: 3000 }"
    ...
    >
      ...
      <div slot="container-end" class="absolute left-0 right-0 top-1/2 z-50">
        ...
        >
          <img
            class="w-20 rotate-180  2xl:w-24 min-[1920px]:w-[180px]"
        ...
        <button
          type="button"
          class="nav-next hidden disabled:opacity-50 lg:block"
          @click="go"
          :disabled="!slides.haveNext"
        >
          <img
            class="w-20  2xl:w-24 min-[1920px]:w-[180px]"
            src="/images/line_end_arrow_notch.png"
            alt="arrow"
          />
        </button>
